...
import com.primeiroboot.course.entities.Payment;
...
import com.primeiroboot.course.repositories.CategoryRepository;
import com.primeiroboot.course.repositories.OrderItemRepository;
import com.primeiroboot.course.repositories.OrderRepository;
import com.primeiroboot.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p3 = new Product(null,"Macbook Pro","Nam eleifend maximus cortor, at mollis.",1250.0,"");
		...
		Payment pay1 = new Payment(null,Instant.parse("2024-04-20T21:53:07Z"),o1);
		o1.setPayment(pay1); //apenas em associacao um-para-um (JPA trata do salvamento)
