package com.primeiroboot.course.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(ResourceNotFoundException.class) //capturar qualquer exceção dessa classe
	...
	@ExceptionHandler(DatabaseException.class) //capturar qualquer exceção dessa classe
